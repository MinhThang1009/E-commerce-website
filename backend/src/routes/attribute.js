...
// Route công khai (dùng cho hiển thị sản phẩm phía frontend)
...
// Route tạo tên sản phẩm (công khai cho frontend dùng)
...
// Route của admin (yêu cầu xác thực và role admin)
...
// Chỉ admin: tạo tên hàng loạt cho sản phẩm
router.post(
