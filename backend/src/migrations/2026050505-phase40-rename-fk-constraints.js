...
const FK_RENAMES = [
  ...
  [
    'chat_messages',
    'chat_messages_product_id_foreign_idx',
    'fk_chat_messages_product',
    'product_id',
    'products',
    'id',
    'SET NULL',
  ...
  [
    'inventory_logs',
    'inventory_logs_ibfk_2',
    'fk_inventory_logs_variant',
    'variant_id',
    'product_variants',
    'id',
    'SET NULL',
  ...
  [
    'inventory_logs',
    'inventory_logs_ibfk_3',
    'fk_inventory_logs_order',
    'order_id',
    'orders',
    'id',
    'SET NULL',
  ...
  [
    'inventory_logs',
    'inventory_logs_ibfk_4',
    'fk_inventory_logs_user',
    'created_by',
    'users',
    'id',
    'SET NULL',
  ...
  [
    'orders',
    'orders_discount_code_id_foreign_idx',
    'fk_orders_discount',
    'discount_code_id',
    'discount_codes',
    'id',
  ...
  [
    ...
    'product_attribute_groups_ibfk_1',
    'fk_pag_product',
    'product_id',
    'products',
    'id',
  ...
  [
    'product_attribute_groups',
    'product_attribute_groups_ibfk_2',
    'fk_pag_group',
    'attribute_group_id',
    'attribute_groups',
    'id',
  ...
  [
    'review_feedbacks',
    'review_feedbacks_ibfk_1',
    'fk_review_feedbacks_review',
    'review_id',
    'reviews',
    'id',
    'CASCADE',
  ...
  [
    'review_feedbacks',
    'review_feedbacks_ibfk_2',
    'fk_review_feedbacks_user',
    'user_id',
    'users',
    'id',
    'CASCADE',
