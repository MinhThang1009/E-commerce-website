...
> 5 tầng test, 259 suites, ~5.487 test cases, coverage 100% lines / 99,81% branches (unit).
...
```
              ...
              ┌─┴──────────────────────────┴─┐
              │  Unit Tests (3.745 + 758)      │  ← Isolated logic + React components
              └────────────────────────────────┘
```
...
**Phạm vi**: 158 test suites, 3.745 test cases.
