...
|---|---|---|---|---|
| BE Unit Tests | 215 | 5.365 | ~12s | `jest.config.js` |
...
> Đo lại 2026-06-06 (§A FE coverage: xóa 25 false-positive istanbul-ignore, thêm 22 test cases; §B payment audit: thêm 2 test cases; §C orders audit: thêm 2 test cases).
