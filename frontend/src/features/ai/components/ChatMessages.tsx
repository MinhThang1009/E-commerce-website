...
const ChatMessages: React.FC<ChatMessagesProps> = ({
  ...
  return (
    <div className="chat-messages glass-messages-bg custom-scrollbar flex-1 overflow-y-auto p-4 sm:p-5 space-y-3">
        ...
        >
          {message.sender === 'ai' && (
            <div className="relative">
              ...
              {/* Chỉ báo trực tuyến - không hiển thị typing indicator ở đây nữa */}
            </div>
          )}
