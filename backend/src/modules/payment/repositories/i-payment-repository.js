...
class IPaymentRepository {
  // Order
  async findOrderByPk(_id, _options) {
    throw new Error('not implemented');
  }
  async findOrderByNumber(_number) {
    throw new Error('not implemented');
  }
  async findOrderByPkWithItemsAndUser(_id) {
    throw new Error('not implemented');
  }
  async lockOrder(_id, _transaction) {
    throw new Error('not implemented');
  }
  async updateOrderPayment(_orderId, _patch, _options) {
    throw new Error('not implemented');
  }
  ...
  async saveUser(_user, _options) {
    throw new Error('not implemented');
  }

  // DiscountCode usage tracking (after payment confirmed)
  async findOrderDiscountCode(_orderId, _options) {
    throw new Error('not implemented');
  }
  async incrementDiscountCodeUsedCount(_codeId, _options) {
    throw new Error('not implemented');
  }
