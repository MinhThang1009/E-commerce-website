    ...
    <div className={baseClasses}>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <Button variant="outline" size="sm" onClick={handlePriceRangeApply} fullWidth>
        ...
        {filterGroups.map((group) => (
          <div key={group.id} className="border-t border-neutral-200 dark:border-neutral-700 pt-4">
            <button
            ...
            {expandedGroups[group.id] && (
              <div className="space-y-2 ml-1">
                {group.options.map((option) => {
                  const isSelected =
                    selectedFilters[group.id]?.includes(String(option.id)) || false;
                  return (
