...
- **5.480 test cases** (259 suites, 5 tầng), coverage 100% lines / 99,81% branches unit, CI/CD với GitHub Actions
...
| Biện pháp | Chi tiết |
|---|---|
| **5.480 test cases** | 5 tầng: Unit → Integration → API HTTP → E2E → Component |
...
|---|---|---|---|---|
| BE Unit Tests | 158 | 3.738 | Mock | ~20s |
