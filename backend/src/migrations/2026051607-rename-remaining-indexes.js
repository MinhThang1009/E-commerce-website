...
const INDEX_RENAMES = [
  ['product_variants',    'product_variants_is_available_idx',            'idx_product_variants_is_available',            'is_available',        false],
  ['product_warranties',  'product_warranties_product_id_idx',            'idx_product_warranties_product_id',            'product_id',          false],
  ['product_warranties',  'product_warranties_warranty_package_id_idx',   'idx_product_warranties_warranty_package_id',   'warranty_package_id', false],
  ['users',               'google_id',                                    'uq_users_google_id',                           'google_id',           true],
  ['warranty_packages',   'warranty_packages_is_active_idx',              'idx_warranty_packages_is_active',              'is_active',           false],
  ['warranty_packages',   'warranty_packages_sort_order_idx',             'idx_warranty_packages_sort_order',             'sort_order',          false],
];
...
const CHECK_RENAMES = [
  ['cart_items',         'warranty_package_ids', 'chk_cart_items_warranty_package_ids',    'json_valid(`warranty_package_ids`)',
  ...
  ['import_logs',        'error_detail',         'chk_import_logs_error_detail',           'json_valid(`error_detail`)',
  ...
  ['order_items',        'attributes',           'chk_order_items_attributes',             'json_valid(`attributes`)',
  ...
  ['order_items',        'warranty_package_ids', 'chk_order_items_warranty_package_ids',    'json_valid(`warranty_package_ids`)',
  ...
  ['product_attributes', 'values',               'chk_product_attributes_values',           'json_valid(`values`)',
  ...
  ['product_reviews',    'rating_value',         'chk_product_reviews_rating_value',        '`rating_value` >= 1 AND `rating_value` <= 5',
    '`rating_value` int(11) DEFAULT NULL',
    '`rating_value` int(11) DEFAULT NULL CHECK (`rating_value` >= 1 AND `rating_value` <= 5)'],
  ['product_variants',   'dimensions',           'chk_product_variants_dimensions',         'json_valid(`dimensions`)',
  ...
  ['reviews',            'images',               'chk_reviews_images',                      'json_valid(`images`)',
  ...
  ['warranty_packages',  'coverage',             'chk_warranty_packages_coverage',           'json_valid(`coverage`)',
  ...
  ['warranty_packages',  'terms',                'chk_warranty_packages_terms',              'json_valid(`terms`)',
...
module.exports = {
  ...
  async down(queryInterface) {
    ...
    if (await tableExists(queryInterface, 'product_reviews')) {
      await queryInterface.sequelize.query(
        "ALTER TABLE `product_reviews` COMMENT = ''"
      );
