...
> 5 tầng test, 260 suites, ~5.512 test cases, coverage 100% lines / 99,81% branches (unit).
...
```
                ...
                ┌─┴──────────────────────┴─┐
                │ Integration Tests (188)   │  ← Service/repo layer (real DB)
              ┌─┴──────────────────────────┴─┐
              │  Unit Tests (3.758 + 766)      │  ← Isolated logic + React components
              └────────────────────────────────┘
```
...
**Phạm vi**: 158 test suites, 3.758 test cases.
...
**Phạm vi**: 36 test suites, 188 test cases.
...
|---|---|---|---|
| BE Unit Tests | 158 | 3.758 | ~20s |
| BE Integration Tests | 36 | 188 | ~55s |
