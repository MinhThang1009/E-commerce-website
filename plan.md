...
- **⚠️ Còn lại:** state-01-order sơ đồ cần re-render (thêm cung delivered→cancelled chặn, shipped→cancelled no-restore); 4 sơ đồ FAIL (state-01/uc-02/uc-03) vẫn chờ vẽ lại theo task gốc.
