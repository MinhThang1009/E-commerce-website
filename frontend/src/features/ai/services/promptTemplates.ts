/**
 * Prompt template gợi ý sản phẩm
 */
...
/**
 * Prompt template hỗ trợ chung
 * @param query Câu hỏi của người dùng
 * @param type Loại hỗ trợ (general, order, return, v.v.)
 */
...
/**
 * Prompt template đề xuất sản phẩm
 */
...
/**
 * Prompt template trả lời câu hỏi thường gặp (FAQ)
 */
