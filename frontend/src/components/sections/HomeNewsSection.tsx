  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 lg:gap-6 h-auto lg:h-[600px]">
        {news.map(
          // eslint-disable-next-line @typescript-eslint/no-explicit-any -- News item fields dynamic
              ...
              >
                ...
                <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-end">
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                    ...
                    <h3
                      className={`font-bold text-white mb-2 leading-tight ${isLarge ? 'text-2xl md:text-3xl' : 'text-xl'} line-clamp-2`}
                    >
                      {item.title}
                    </h3>
