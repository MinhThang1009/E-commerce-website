...
module.exports = {
  async up(queryInterface) {
    const safe = async (sql) => {
      try { await queryInterface.sequelize.query(sql); } catch (e) {
    ...
    const tables100 = ['addresses', 'attribute_groups', 'attribute_values', 'feedbacks', 'product_attributes', 'product_specifications'];
