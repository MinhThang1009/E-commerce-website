...
> 5 tầng test, 325 suites, ~7.268 test cases, coverage 100% lines / 99,81% branches (unit). +2 tầng test-quality: mutation (Stryker) + property-based (fast-check) — xem [§13](#13-mutation--property-based-testing).
