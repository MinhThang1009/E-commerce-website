...
class AIService {
   ...
   */
  async handleMessage({ message, userId, sessionId, enableTrace = false, onStep = null }) {
    return this.chatbotService.handleMessage(message, userId, sessionId, { enableTrace, onStep });
  }
