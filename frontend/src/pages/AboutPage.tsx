...
const AboutPage: React.FC = () => {
  ...
  const teamMembers = [
    { name: 'Sarah Johnson', role: t('about.teamMember1.role'), image: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
    { name: 'Michael Chen', role: t('about.teamMember2.role'), image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
    { name: 'Emily Rodriguez', role: t('about.teamMember3.role'), image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
    { name: 'David Kim', role: t('about.teamMember4.role'), image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=80' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((value, index) => (
            ...
            >
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed tabular-nums">{value.description}</p>
            </div>
          ))}
        </div>
      </div>
