...
- **~7.504 test cases** (286 suites, 5 tầng), coverage 99.7%+ lines/statements (local), CI/CD với GitHub Actions
...
| Biện pháp | Chi tiết |
|---|---|
| **~7.504 test cases** | 5 tầng: Unit → Integration → API HTTP → E2E → Component |
...
|---|---|---|---|---|
| BE Unit Tests | 176 | 5.581 | Mock | ~13s |
